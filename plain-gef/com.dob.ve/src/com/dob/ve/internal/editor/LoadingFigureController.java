...
/**
 * @author idanilov
 * @see JaveVisualEditorLoadingFigureController
 * TODO: simplify.
 */
class LoadingFigureController {
	...
	public void startListener(GraphicalViewer viewer) {
		...
		loadingFigure.setBackgroundColor(ColorConstants.tooltipBackground);
		loadingFigure.setCursor(Cursors.WAIT);//[ID]
	...
	protected Layer getLoadingLayer() {
		return (Layer) LayerManager.Helper.find(viewer.getRootEditPart()).getLayer(
